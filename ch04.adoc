...
In data written ##in CF versions before 1.13## with the **`standard`** calendar for dates since 1972, datetimes and time coordinates should be regarded as uncertain by a number of seconds (but less than a minute), because leap seconds may or may not have been taken into account.
...
##In data written with CF 1.13 or later in the **`standard`** calendar##,

* ##datetimes since 1972 are UTC##,

* ##time coordinates and datetimes should be interconverted assuming 60 seconds in every minute (i.e. no leap seconds), and##
