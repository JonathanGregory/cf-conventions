...
If time coordinates in the **`utc`** calendar are converted to datetimes by software that ##does not take leap seconds into account##pass:q[<del><span style="color: red">is unaware of leap seconds</span></del>], they will be later than the correct UTC datetimes by a number of seconds.
+
